...
@section('title', 'Permissoes {$profile->name}')

@section('content_header')
<h1>Permissoes do Usuario {{ $profile->name }}
    <a href="{{ route('profiles.create') }}" class="btn btn-dark"><i class="fa-solid fa-address-card"></i>Adicionar</a>
</h1>
